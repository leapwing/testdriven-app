...
then
    ...
    if [[ "$TRAVIS_BRANCH" == "staging" ]]; then
        ...
        export REACT_APP_USERS_SERVICE_URL="http://testdriven-staging-alb-681387798.ap-southeast-1.elb.amazonaws.com"
        export REACT_APP_EXERCISES_SERVICE_URL="http://testdriven-staging-alb-681387798.ap-southeast-1.elb.amazonaws.com"
        export REACT_APP_SCORES_SERVICE_URL="http://testdriven-staging-alb-681387798.ap-southeast-1.elb.amazonaws.com"
        elif [[ "$TRAVIS_BRANCH" == "production" ]]; then
        export DOCKER_ENV=prod
        export REACT_APP_USERS_SERVICE_URL="http://testdriven-production-alb-692597783.ap-southeast-1.elb.amazonaws.com"
        export REACT_APP_EXERCISES_SERVICE_URL="http://testdriven-production-alb-692597783.ap-southeast-1.elb.amazonaws.com"
        export REACT_APP_SCORES_SERVICE_URL="http://testdriven-production-alb-692597783.ap-southeast-1.elb.amazonaws.com"
